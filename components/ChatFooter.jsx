...
const ChatFooter = () => {
  ...
  const {isTyping, editMsg, data, setEditMsg, inputText, setInputText,  setAttachment, setAttachmentPreview, attachmentPreview } = useChatContext();
  ...
  return (
    ...
    p-2 rounded-xl relative">
     {attachmentPreview && (
      ...
      bottom-16 left-0 bg-c1 p-2 rounded-md">
        <img src={attachmentPreview} />
        <div className="w-6 h-6 rounded-full 
        bg-red-500 flex justify-center 
    ...
    {isTyping && (
    <div className="absolute -top-6 left-4 bg-c2
    w-full h-6">
