...
const Search = () => {
    ...
    const onkeyp  = async (e) => {
        if(e.code === "Enter" && !!username){
            try {
                ...
                const q = query(usersRef, where("displayName", "==",
                username));
  ...
  return (
    <div className="shrink-0">
        ...
        {user && (<>
            <div className=" mt-5 flex items-center gap-4 rounded-xl
             hover:bg-c5  py-2 px-4 cursor-pointer"
              ...
              <div className="flex flex-col gap-1 grow">
                <span className="text-base text-white flex items-center justify-between">
                  <div className="font-medium">{user.displayName}
                   ...
                   <p className="text-small text-c3">
                       {user.email}
                   </p>
               </div>
